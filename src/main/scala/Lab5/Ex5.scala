...
val alg5 = VariableElimination(player1Card,player2Card,player1Bet1,player2Bet)
alg5.start()
println("Probabilitatea ca aceasta sa se intample este :" + alg5.probability(player1Card,5) * alg5.probability(player2Card,4) * alg5.probability(player1Bet1,true) * alg5.probability(player2Bet,true))
alg5.stop();
}
}